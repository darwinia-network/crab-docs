          ...
          {status === FaucetClaimResultStatus.IS_CLAIMED ? (
            ...
            <>
              ...
              <Input
                ...
                placeholder={
                  tokenSymbol === "CRAB"
                    ? "Please enter your Crab Smart Address which starts with 0x"
                    : "Please enter a substrated-based Pangolin Chain address starting with 5"
                }
              />
              {tokenSymbol === "CRAB" ? (
                isValidAddress ? (
                  <span className={`${style.extraNormal} ${style[tokenSymbol.toLowerCase()]}`}>
                    Please enter your Crab Smart Address to claim token CRAB, learn more about Crab Smart Address,
                    please refer{" "}
                    <a
                      target="_blank"
                  ...
                  <span className={`${style.extraWarning} ${style[tokenSymbol.toLowerCase()]}`}>
                ...
                <span
                  className={`${isValidAddress ? style.extraNormal : style.extraWarning} ${
                    style[tokenSymbol.toLowerCase()]
                  }`}
                >
                  Please enter a substrated-based Pangolin Chain address. And you can use{" "}
                  <a target="_blank" rel="noopener noreferrer" href="https://wormhole.darwinia.network/">
                    Wormhole
                  </a>{" "}
                  to transfer your PRING between Pangolin Chain and Pangolin Smart Chain.
                </span>
              )}
            </>
          )}
