...
![setting](../assets/substrate-based-crab-chain/create-account-01.png)
...
![create account](../assets/substrate-based-crab-chain/create-account-02.png)
...
![create account](../assets/substrate-based-crab-chain/create-account-03.png)

Click the "Create and Backup Account" button to back up the account "json file"

![create account](../assets/substrate-based-crab-chain/create-account-04.png)
...
![create account](../assets/substrate-based-crab-chain/create-account-05.png)
![create account](../assets/substrate-based-crab-chain/create-account-06.png)
...
![create account](../assets/substrate-based-crab-chain/create-account-07.png)
...
![faucet](../assets/substrate-based-crab-chain/create-account-08.png)
...
![faucet](../assets/substrate-based-crab-chain/create-account-09.png)

- Click [Save], according to your usage habits, choose to back up the original seed or json file

![faucet](../assets/substrate-based-crab-chain/create-account-10.png)
...
![polkadot-js](../assets/substrate-based-crab-chain/create-account-11.png)
...
![polkadot-js](../assets/substrate-based-crab-chain/create-account-12.png)

![polkadot-js](../assets/substrate-based-crab-chain/create-account-13.png)

![polkadot-js](../assets/substrate-based-crab-chain/create-account-14.png)
...
![polkadot-js](../assets/substrate-based-crab-chain/create-account-15.png)
