...
If you have not yet done so, create a MetaMask Account, [connect to Pangolin](/dvm-metamask.md), and fund it through [Mission Control](/builders/get-started/darwinia-pangolin/#get-tokens/). We will use the private key of the account created to deploy the contract.
