...
If you have not yet done so, create a MetaMask Account, [connect to Pangolin](../../get-started/use-metamask.md), and fund it through [Faucet](https://apps.darwinia.network/?network=pangolin). We will use the private key of the account created to deploy the contract.
